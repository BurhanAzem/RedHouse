...
class LandlordContract extends StatefulWidget {
  Contract contract;
  LandlordContract({Key? key, required this.contract}) : super(key: key);
              ...
              child: DefaultTabController(
                ...
                child: Scaffold(
                  ...
                  body: TabBarView(
                    children: [
                      Center(
                          child: LandlordOverview(contract: widget.contract)),
                      Center(child: LandlordDetails(contract: widget.contract)),
                    ],
                  ),
                ),
              ),
