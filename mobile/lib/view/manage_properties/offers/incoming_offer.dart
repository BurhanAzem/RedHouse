...
class _IncomingOffeState extends State<IncomingOffer>
  ...
  Widget widget4() {
    bool isOfferExpired() {
      ...
      DateTime offerExpires = widget.offer.offerExpires;
      return now.isAfter(offerExpires);
    }

    bool isOfferEnded = isOfferExpired();
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              if (widget.offer.offerStatus == "Pending" && !isOfferEnded)
                acceptRejectButtons()
              // Show "See Contract"
              else if (widget.offer.offerStatus == "Accepted")
                contractButton(),
            ],
          ),
        ),
