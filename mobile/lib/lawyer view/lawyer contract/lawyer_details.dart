...
class LawyerDetails extends StatefulWidget {
  ...
  const LawyerDetails({Key? key, required this.contract}) : super(key: key);
  @override
  _LandlordDetailsState createState() => _LandlordDetailsState();
}

class _LandlordDetailsState extends State<LawyerDetails> {
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) => ChatPage(
                        receiverUserEmail:
                            widget.contract.offer!.customer!.email!,
                        receiverUserID:
                            widget.contract.offer!.customer!.id.toString(),
                        onMessageSent: () {
                          if (mounted) {
                            setState(() {});
                          }
                  ...
                  MaterialButton(
                    onPressed: () {
                      Get.to(() => CustomFeedback.Feedback(
                            ...
                            userId: widget.contract.offer!.customerId,
                          ));
                    },
                    child: Container(
                      width: 500,
                      ...
                      decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(15)),
                      child: const Text(
                        "Give feedback about the customer",
                        style: TextStyle(fontWeight: FontWeight.w600),
                      ),
                    ),
                  ),
