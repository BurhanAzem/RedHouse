...
class LawyerComplints extends StatefulWidget {
  const LawyerComplints({super.key});

  @override
  State<LawyerComplints> createState() => _LawyerComplintsState();
}

class _LawyerComplintsState extends State<LawyerComplints> {
  ComplaintController controller = Get.put(ComplaintController());
  LoginControllerImp loginController = Get.put(LoginControllerImp());
  // Color primaryColor = Color.fromARGB(255, 208, 103, 55)!;
  // Color primaryColor = Colors.blue[600]!;
  // Color primaryColor = Color.fromARGB(255, 23, 77, 138);
