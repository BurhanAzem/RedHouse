            ...
            children: [
                 ...
                 Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        InkWell(child: Text("Don't have an account"), onTap: () {
                          controller.goToSignUp();
                        },),
                        InkWell(child: Text("Forgot password")) // Corrected "Forget" to "Forgot"
                      ],
                    ),
                  ],
                ),
              ...
              MaterialButton(
                ...
                child: Text(
                  "Login as visitor",
                  style:
                      TextStyle(color: Color(0xffd92328), fontWeight: FontWeight.w700),
                ), // Provide a child for the bu),
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(10),
