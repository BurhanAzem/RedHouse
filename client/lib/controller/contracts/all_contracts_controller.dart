...
class AllContractsControllerImp extends AllContractsController {
  ...
  List<Contract>? Contracts = [
    new Contract(
      "Property on the 5 floor, Build with modern styles",
      "Bassam T",
      "Burhan A",
      "Property on the 5 floor, Build with modern styles Property on the 5 floor, Build with modern styles Property on the 5 floor, Build with modern styles Property on the 5 floor, Build with modern styles",
      1,
      DateTime(2023, 10, 30),
      9000,
      "For rent",
